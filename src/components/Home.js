  ...
  return (
   ...
   <div id="Home">
    ...
    <p data-aos="fade-down"
     ...
     style={{fontSize:'40px',color:'red'}}>Raihana A</p>
    <h4><Typed strings={['Web Developer','Freelancer','Web Designer','App Developer']}
    typeSpeed={140}
    backSpeed={100}
    loop={true}></Typed></h4>
    ...
    <button id='btn1'><a href='./2139492-Raihana.pdf' id='download' download>DownloadCV</a></button>   
     
   <Nav.Link href="#Blog"><button id="btn2" className='button' >Contact Me</button></Nav.Link></div></div> 
    ...
    {/* <div id='exp'>
     ...
     <div id="icons">
    <ol><SocialIcon url="https://linkedin.com/in/raihana-a-179aa924a" /></ol>
    <ol><SocialIcon url="https://github.com/123Raihana" /></ol>
    <ol><SocialIcon url="https://whatsapp.com/9361572102" /></ol>
    <ol><SocialIcon url="https://web.telegram.org/z/#1679652113" /></ol>
    </div>
    </div>
